...
void NavDelegate::paint( QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index ) const
{
	...
	if ( node->children.size() != 0 )
	{
		...
		{
			if ( option.state & QStyle::State_Selected )
                imgPath = ":/new/images/unexpand_selected.png";
			else
                imgPath = ":/new/images/unexpand_normal.png";
		}
		else
		{
			if ( option.state & QStyle::State_Selected )
                imgPath = ":/new/images/expand_selected.png";
			else
                imgPath = ":/new/images/expand_normal.png";
		}
