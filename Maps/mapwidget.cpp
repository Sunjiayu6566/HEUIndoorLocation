...
Mapwidget::Mapwidget(QWidget *parent)
    ...
    ui(new Ui::Mapwidget)
 {
    ...
    maps_manage=new MapsManage;
    maps_infor=new Mapsinformation;

    maps_manage->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
    maps_infor->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);

    m_stackedwidget=new QStackedWidget;
    m_stackedwidget->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
    m_stackedwidget->addWidget(maps_manage);
    m_stackedwidget->addWidget(maps_infor);
    ...
    model->ReadDataFromConfig("Maps.xml");
